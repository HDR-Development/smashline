...
#[skyline::hook(offset = 0x37209b4 + 0x5B0, inline)]
...
pub fn install_param_hooks() {
    skyline::patching::Patch::in_text(0x37209b4 + 0x5B0).nop().unwrap();
